...
const CustomButton = () => {
  ...
  return (
    <Wrapper>
      ...
      <a href="https://seller.flipkart.com/sell-online?utm_source=fkwebsite&utm_medium=websitedirect"><Typography style={{ marginTop: 10, width: 135, cursor:'pointer' }}>Become a Seller</Typography></a>
